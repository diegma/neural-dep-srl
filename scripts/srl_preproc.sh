...
cut -f4 conll2009.combined | python3 -mnnet.ml.voc --tokenizer space >frames.voc.conll2009
...
cut -f8 conll2009.combined | python3 -mnnet.ml.voc --tokenizer space >labels.voc.conll2009
