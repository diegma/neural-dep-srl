...
--soft-warnings \
--epochs 15 \
--out conll2009_rm0_pl_a.25_sskip_h512_d.0_l3_gcn_1_gc_drop_.2 \
--hps "{'id': 1, 'sent_edim': 100, 'sent_hdim': 512, \
'frame_edim': 128, 'role_edim': 128, 'pos_edim': 16, 'rec_layers': 3, \
'pos': True, 'rm':0, 'alpha': 0.25, 'gc_layers': 1, 'gcb_hdim': 1024, 'gc_dropout': 0.2, \
'p_lemmas':True}"
